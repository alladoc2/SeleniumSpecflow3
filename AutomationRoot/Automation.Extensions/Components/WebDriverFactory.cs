...
namespace Automation.Extensions.Components
{
    public class WebDriverFactory
    {
       ...
       /* or this: {
        ...
        private IWebDriver GetInternetExporer() => new InternetExplorerDriver(driverParams.Binaries);
        ...
        private IWebDriver GetDriver()
        {
            ...
            { 
                ...
                case "IE": return GetInternetExporer();
        ...
        public IWebDriver Get()
        {
           ...
           // if (!string.Equals(driverParams.Source.ToUpper(), "REMOTE",StringComparison.OrdinalIgnoreCase))
            {
                return GetDriver();
            }
        ...
        private IWebDriver GetRemoteInternetExporer()
        ...
        private IWebDriver GetRemoteDriver()
        {
            switch (driverParams.Driver.ToUpper())
            {
                ...
                case "IE": return GetRemoteInternetExporer();
